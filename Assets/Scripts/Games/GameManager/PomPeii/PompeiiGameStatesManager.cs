...
{
    public class PompeiiGameStatesManager : GameStatesManager
    {
        [SerializeField] PompeiiBonusSpecialRules _pompeiiBonusSpecialRules;
        protected override IEnumerator StateRoundRunning(StatesController attachedStatesController)
        {
            ...
            else
            {
                ...
                _pompeiiBonusSpecialRules.RecordLockedReel(roundResultData.showedIconsId);
            ...
            {
                //Wushih-公版沒有
                _pompeiiBonusSpecialRules.OpenAndCloseFakeReel();
            }
        ...
        protected override IEnumerator WaitForExitingBonusGameTransition(bool isAutoPlay)
        {
            ...
            _pompeiiBonusSpecialRules.LeaveBonusGameUnLockReel();
